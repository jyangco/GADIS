...
export class Internal extends Component {
    ...
    render() {
        ...
        const SO = [...new Set(respubs.filter(so => so.file_subcategory == "Special Orders" && so.file_type == "Internal").map((item) => item.issuance_year))]
        const SOyear = SO.sort().reverse()
        const MO = [...new Set(respubs.filter(mo => mo.file_subcategory == "Memorandum" && mo.file_type == "Internal").map((item) => item.issuance_year))]
        const MOyear = MO.sort().reverse()
        return (
            <div className="card-body p-0 m-0">
                <div className="text-center text-3xl mobile-lg:!text-2xl"> Internal Files </div>
                ...
                <div className="tab-content -mt-1 border-t-2 border-dark mobile-lg:!hidden">
                    {activeTab == 1 ?
                        <div className="tab-buttons mt-2 w-100 flex flew-wrap justify-content-evenly text-xl">
                            <button
                ...
                <div className="menu-content -mt-1 border-t-2 border-dark">
                    ...
                    {activeTab == 1 && activeMenuR == 1 ?
                        <div className="p-4 mobile-lg:!hidden">
                            <div className="my-1 mx-4 justify-content-center p-2 list-disc flex flex-wrap">
                                {respubs
                                    .filter(
                                        type => 
                                            type.file_type == "Internal" && 
