...
export class GPB extends Component {
    constructor(props){
        super(props)
        this.state = {
            filterYear: "",
                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <div ref={ el => (this.componentRef=el) } id='toPrint' className="p-1 text-base">
                            ...
                            <div className="text-center text-xl fw-bold"> FY {filterYear} </div>
                                    ...
                                    <div className="d-flex">
                                        <div className="w-75">
                                            <div className="d-flex">
                                                ...
                                                <div className="w-50">
                                                    <div className="d-flex">
                                                        <div className="w-50 border-end border-bottom px-3 py-1">
                            ...
                            {role == "admin" && this.state.filterYear.length != 0 ?
                                <div className="d-flex justify-content-center mt-5">
                                    <Link to={`/Reports/GPB/${this.state.id_number}`} state={{ id: `${this.state.id_number}` }} className="text-decoration-none bg-green-300 px-5 py-2 hover:bg-green-500 hover:text-white hover:shadow-2xl">
                                        Check Progress
                                    </Link>    
                                </div> : ""
                            }
